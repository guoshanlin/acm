  ...
  export default {
    data() {
      return {
        ...
        menuList: [
          {icon: 'ios-person', path: "/allFinance/allAccount", title: "所有账户"},
          {icon: 'arrow-graph-up-right', path: "/allFinance/allIncome", title: "收入明细"},
          {icon: 'arrow-graph-down-right', path: "/allFinance/allDetails", title: "提现明细"}
        ]
      }
    },
    created() {
