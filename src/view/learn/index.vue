<template>
  <div class="learn">
    <div class="wrapper-box fbox">
      <div>
        <div class="t-right learn-title">学习:</div>
      </div>
      <div class="flex">
    ...
    <div class="wrapper-box m-t15">
      <div class="fbox">
        <div class="flex wrapper-box">
          <div class="list-item" v-for="item in data" :key="item.id" @click="routePush('/index/activities',item.id,'learn')">
...
<style scoped>
  ...
  .learn .ivu-radio-group-button .ivu-radio-wrapper:last-child,.ivu-radio-group-button.ivu-radio-group-small .ivu-radio-wrapper:first-child{border-radius:0;}
</style>
