    ...
    <article class="box triangle b m-b10">
      <article class="post_main">
        ...
        <div class="clear">
          ...
          <div class="fr">
            <span v-if="row.isNeedPay == 0">票券信息:&nbsp;免费票</span>
            <span v-if="row.isNeedPay == 1">票券信息:&nbsp;<span class="span-title">非会员价:</span>&nbsp;{{row.nonMBPrice}}元&nbsp;&nbsp;&nbsp;<span class="span-title">会员价:</span>&nbsp;{{row.mbPrice}}元</span>
          </div>
        </div>
      </article>
    </article>
